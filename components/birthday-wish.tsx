    ...
    >
      <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl rounded-lg border border-gray-200">
        <CardHeader className="text-center bg-gradient-to-br from-blue-400 to-purple-500 py-6">
          <CardTitle className="text-3xl font-extrabold text-white">Happy 20th Birthday!</CardTitle>
          <CardDescription className="text-lg font-medium text-gray-200">Huzaifa Aziz</CardDescription>
          <p className="text-md text-gray-100">on 4th December</p>
        </CardHeader>
